...
<form class="lw-ajax-form lw-form" method="post" action="<?= route('manage.configuration.write', ['pageType' => request()->pageType]) ?>">
	<div class="col-12 mb-3 alert alert-dark">
		<?= __tr('By boosting their profile they will be a part of featured users and will get priority in search and random users for the specified time & credits below.') ?>
	</div>
