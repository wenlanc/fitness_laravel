...
<div class="row">
    <div class="col-lg-3">
        ...
        <div class="list-group">
            ...
            <!-- Promotion Plans Settings -->
            <a class="list-group-item list-group-item-action <?= $pageType == 'promotion-plans' ? 'active' : '' ?>" href="<?= route('manage.configuration.read', ['pageType' => 'promotion-plans']) ?>"><?= __tr('Promotion Plans') ?></a>
            <!-- /Promotion Plans Settings -->
