		...
		<fieldset class="lw-fieldset mb-3">
			...
			<legend class="lw-fieldset-legend">
				...
				<div class="custom-control custom-switch">
					<input type="checkbox" class="custom-control-input" id="lwAllowStaticCityData" <?= (($configurationData['use_static_city_data'] == true) and ($configurationData['allow_google_map'] != true)) ? 'checked' : '' ?> name="use_static_city_data" value="1">
					<label class="custom-control-label" for="lwAllowStaticCityData"><?= __tr('Use Static City data and OpenStreetMap using Leaflet.js') ?> <br>
						<small class="text-muted"><?= __tr('It will use static city data from database to determine user latitude/longitude') ?></small>
					</label>
				</div>
				<!-- enable google map hidden field -->
				...
				<div class="custom-control custom-switch">
					...
					<label class="custom-control-label" for="lwAllowGoogleMap"><?= __tr('Use Google Map API') ?> <br>
						<small class="text-muted"><?= __tr('It will be used to determine user latitude/longitude based on selected location') ?></small>
					</label>
				</div>
			</legend>
			<!-- /allow google map input radio field -->
			...
			<div class="mb-3 small">
				<a class="text-info" href="https://console.cloud.google.com/" target="_blank"><?= __tr('You need to enable __placesAPI__, __mapsJSAPI__, __geocodingAPI__', [
		...
		<fieldset class="lw-fieldset mb-3">
			...
			<legend class="lw-fieldset-legend">
				...
				<div class="custom-control custom-switch">
					...
					<label class="custom-control-label" for="lwAllowPusher"><?= __tr('Allow Pusher') ?>
						<small class="text-muted"><?= __tr('(Required for realtime communication)') ?></small>
					</label>
				</div>
			</legend>
			<!-- /allow pusher input radio field -->
			...
			<fieldset class="lw-fieldset mb-3 mt-4">
				...
				<legend class="lw-fieldset-legend">
					...
					<div class="custom-control custom-switch">
						...
						<label class="custom-control-label" for="lwAllowAgora"><?= __tr('Allow Agora') ?>
							<small class="text-muted"><?= __tr('(Required for Audio/Video Calls)') ?></small>
						</label>
					</div>
				</legend>
				<!-- /allow agora input radio field -->
