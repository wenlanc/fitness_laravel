...
<div style = "background: #1E1E1E;
	...
	<div class="row" style="height:100%;">
			...
			<div style="max-width: 18vw; margin:auto;">
				...
				<div class="card mb-2">
					...
					<div class="mb-2">
						...
						@if( !__isEmpty($userProfileData['aboutMe']))
							<div class="d-flex1 mt-2" style="font-weight: bold;font-size: 1rem;line-height: 1.5rem; min-height:90px;color: #929292;word-break: break-word;">
								<span class="text-4-lines" data-model="profileData.aboutMe"><?= $userProfileData['aboutMe']; ?></span>
								<span style="float:right;"> <a style="color:#FF3F3F;font-weight: 700;font-size: 0.75rem;line-height: 1rem;" href="#" role="button" data-toggle="modal" data-target="#lwBioDetailDialog"> See More </a></span>
							</div>
						@else
							<div class="d-flex mt-2" style="font-weight: bold;font-size: 1rem;line-height: 1.5rem;min-height:90px;color: #929292;word-break: break-word;">
								<span data-model="profileData.aboutMe">No Bio</span>
							</div>
						@endif
					</div>
					...
					<div class="mb-3" id="lwAvailabilityForm">
						<form class="lw-ajax-form lw-form" lwSubmitOnChange method="post" data-show-message="true" action="<?= route('user.write.availability'); ?>" data-callback="getUserProfileData">
							<div class="d-flex align-v-center pt-1" style="align-items: center;">
							...
							<div class="d-flex align-v-center pt-1">
					...
					<div class="d-flex" >
						...
						@else
							...
							<div class="" style="margin-left: auto;"> 
								<a style="color:#FF3F3F;font-weight: 700;font-size: 0.75rem;line-height: 1rem;" href="#" onclick="showReviewsDetailModal()">
									View All
								</a>
							</div>
							@endif
					...
					@if(count($reviewUserData))
					<div class="profile_reviews_container" style="max-height: 170px;overflow-y: auto;padding-right: 15px;">
						@foreach($reviewUserData as $review)											
							<div class="profile_review_item mb-2">
								<div class="profile_review_header" style="display:flex;">
									...
									<div class="profile_review_name"  style="padding-left: 5px;padding-right: 5px;">
					...
					@else
					<div class="profile_reviews_container" style="max-height: 170px;overflow-y: auto;padding-right: 15px;">
						<div style="color: #929292;"> No reviews </div>				
					</div>					
					@endif
					<!-- end of reviews-->
				</div>
		...
		<div class="col-sm-1 col-md-9 position-relative" style="height:100%;">
			@if( $userData['userRoleId'] == 3 )						
			...
			<div class="card mb-3 p-3 profile-block" style="margin-right: -0.5rem;">
				...
				<div class="tab-content" style="
					...
					<div class="card-body tab-pane active in" id="photos_tab">
						<div style = "max-height: <?= $userData['userRoleId'] == 3?"calc(19vw )":"36vw"?>;overflow-y: auto;overflow-x: hidden;" class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 text-center lw-horizontal-container photos_tab_container">
							
						</div>
					</div>
					<div class="card-body tab-pane fade"  id="tagged_tab">
						<div style = "max-height:<?= $userData['userRoleId'] == 3?"calc(19vw)":"36vw"?>;overflow-y: auto;overflow-x: hidden;" class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 text-center lw-horizontal-container photos_tagged_tab_container">
							
						</div>
					</div>
					<div class="card-body tab-pane fade"  id="favourite_tab">
						<div style = "max-height: <?= $userData['userRoleId'] == 3?"calc(19vw)":"36vw"?>;overflow-y: auto;overflow-x: hidden;" class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 text-center lw-horizontal-container photos_favourite_tab_container">
			...
			@if( $userData['userRoleId'] == 3 )	
			<div class="card p-3 profile-block" style="left:0.75rem;right: 0.25rem; position:absolute;width:auto; bottom: 0px; min-height: calc(2vw + 470px );">
				<div class="card-header" style="padding:0;border-bottom:none;">
					@if($isOwnProfile)
					<span class="float-right">
			...
			@else
			<div class="row" style="left:0.75rem;right: 0.25rem; position:absolute;width:auto; bottom: 0px;height: calc( 860px - 20vw);">
				<div class="col-sm-1 col-md-8" style="height:100%;">
					<div class="card p-3 profile-block" style="height:100%;">
						<div class="card-header" style="padding:0;border-bottom:none;">
							@if($isOwnProfile)
							<span class="float-right">
								<a class="lw-icon-btn profile_edit_icon" href role="button" id="lwEditUserLocation">
				...
				<div class="col-sm-1 col-md-4" style="height:100%;">

					<div class="card p-3 profile-block" style="height: 100%;margin-left:-1rem;">
						<div class="card-header" style="padding:0;border-bottom:none;">
...
<div class="modal fade"  id="lwBioDetailDialog" tabindex="-1" role="dialog" aria-labelledby="lwBioDetailDialog" aria-hidden="true">
	<div class="modal-dialog modal-md modal-dialog-centered" role="document">
		<div class="modal-content" style="background-color: #191919;padding: 20px;/*box-shadow: 0px 6px 58px rgba(121, 145, 173, 0.195504);*/border-radius: 24px; ">
			<div class="modal-header" style="border-bottom:none;">
				<h5 class="modal-title" style="color:#FF3F3F; font-family: Nunito Sans;font-style: normal;font-weight: bold;font-size: 1.25rem;line-height: 1.5rem;">
					Bio
				</h5>
				<button type="button" style="color:#FFFFFF;margin-top: -40px; margin-right:-40px; " class="close" data-dismiss="modal" aria-label="Close">
					<span style="padding: 5px 10px;background: #202020;border-radius: 14px;" aria-hidden="true">×</span>
			...
			<div class="modal-body" style="color:#FFFFFF;">
                    <div class="d-flex" style="">
						...
						<div class="profile_review_item mb-2">
							<div class="profile_review_header" style="display:flex;">
								<div class="review_image">
									<img class="lw-lazy-img" style="border: 2px solid #FF3F3F;border-radius: 10px;width: 69px; height: 69px;" id="lwProfilePictureStaticImage" data-src="<?= imageOrNoImageAvailable($userData['profilePicture']); ?>">
								</div>
								<div class="profile_review_name" style="padding-left: 1rem;padding-right: 0.5rem;">
									<div class="profile_review_username">
										<span class="lw-inline-edit-text mr-2" style="margin-top: 0px; font-size:1.5rem;" data-model="userData.kanji_name"><?= __ifIsset($userData['kanji_name'], Str::limit($userData['kanji_name'],24), '-'); ?> </span>				
									</div>
									<div class="profile_review_star_rate mt-2">
										<i class="fas fa-map-marker-alt"></i> &nbsp; 
										<span class="mr-3"><span data-model="profileData.city"><?= $userProfileData['city']; ?></span>, <span data-model="profileData.country_name"><?= $userProfileData['country_name']; ?></span></span>
								...
								<div class="">
									<div class="" style="margin-top:0.25rem; border: 2px solid #FF4141;border-radius: 8px;padding: 0.2rem 0.25rem;">
										<span class="pt_userrate_star review-rating-1" data-rating="<?= $totalReviewRate/5 ?>" > 
										</span> 
										<span style="top: 2px;position:relative;padding-right: 2px;"> <?= $totalReviewRate * 1 ?> </span>
									</div>								
					...
					<div class="d-flex" style="">																								
						<div data-model="profileData.aboutMe" style="font-family: Nunito Sans;
									font-style: normal;
									font-size: 1rem;
									line-height: 22px;
									color: #DCDCDC;
...
<div class="modal fade"  id="lwReviewsDetailDialog" tabindex="-1" role="dialog" aria-labelledby="lwReviewsDetailDialog" aria-hidden="true">
	<div class="modal-dialog modal-md modal-dialog-centered" role="document">
		<div class="modal-content" style="background-color: #191919;padding: 20px;/*box-shadow: 0px 6px 58px rgba(121, 145, 173, 0.195504);*/border-radius: 24px; ">
			<div class="modal-header" style="border-bottom:none;align-items:center;">
				<h5 class="modal-title" style="color:#FF3F3F; font-family: Nunito Sans;font-style: normal;font-weight: bold;font-size: 1.25rem;line-height: 1.5rem;">
					Reviews (<?= count($reviewUserData) ?>)
				</h5>
				...
				<button type="button" style="color:#FFFFFF;margin-top: -40px; margin-right:-40px; " class="close" data-dismiss="modal" aria-label="Close">
					<span style="padding: 5px 12px;background: #202020;border-radius: 14px;" aria-hidden="true">×</span>
				</button>
			</div>
			<div class="modal-body" style="color:#FFFFFF;">
				@if(count($reviewUserData))
				<div class="profile_reviews_container" style="max-height: 500px;overflow-y: auto;padding-right: 15px;">
					@foreach($reviewUserData as $review)											
						<div class="profile_review_item mb-2">
							<div class="profile_review_header" style="display:flex;">
								<?php
								...
								<div class="profile_review_name"  style="padding-left: 5px;padding-right: 5px;">
									...
									<div class="profile_review_star_rate d-flex">
										<div class="review-rating jq-stars" data-rating="<?= $review["rate_value"]?>">
										</div>
										<div style="font-size:0.75rem;color: #C0C0C0;align-items: center; display: flex;  padding-top: 0.25rem; margin-left: auto;"> &nbsp;&nbsp;&nbsp;&nbsp; Reviewed on <?= formatDate($review["created_at"], 'd/m/Y')?></div>								
									</div>								
								</div>
								<div class="profile_review_type_badge">
									<div><?= $review["userRoleName"]?></div>
								</div>
							</div>
...
function showReviewsDetailModal() {
	$('#lwReviewsDetailDialog').modal('show');
}
