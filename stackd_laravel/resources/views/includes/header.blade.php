...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('dist/blackfit/css/font-awesome.css') }}"/>
	<link rel="stylesheet" type="text/css" href="{{ asset('dist/star-rating-svg/css/star-rating-svg.css') }}"/>
