...
<nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" style="">
    ...
    <ul class="navbar-nav ml-0">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <a style="display:none;" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <!-- buy premium plans page link hidden -->
    @if(!isPremiumUser())
    <a style="display:none;" href="<?= route('user.premium_plan.read.view') ?>" class="btn btn-primary btn-sm hide" title="<?= __tr('Be Premium User') ?>"><?= __tr('Be Premium') ?></a>
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown no-arrow mx-1 d-none d-sm-none d-md-block">
            ...
            <!-- Dropdown - Alerts -->
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown" style="background:transparent;">
                <h6 class="d-none dropdown-header">
                    <?= __tr('Notification') ?>
                </h6>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="chat-users-list"> 
                            <div id="lwNotificationContent" class="dropdown-message-list notification-list-container1"> 
                            </div> 
                        </div>
                    </div>
                </div>
                <!-- Notification block -->
                <script type="text/_template" id="lwNotificationListTemplateOld">
                ...
                <script type="text/_template" id="lwNotificationListTemplate">
                    <% if(!_.isEmpty(__tData.notificationList)) { %>
						...
						<% }); %>
						<!-- show all notification link -->
						<a class="pull-right pt-2 small text-gray-500" href="<?= route('user.notification.read.view') ?>" id="lwShowAllNotifyLink" data-show-if="showAllNotifyLink"><?= __tr('Show All Notifications.') ?></a>
						<!-- /show all notification link -->
					<% } else { %>
						<!-- info message -->
						<div class="col-sm-12 alert alert-info">
                            <?= __tr('There are no notification.') ?>
                        </div>
						<!-- /info message -->
					<% } %>
				</script>
