...
return [
    ...
    'items' => [
        ...
        'promotion-plans' => [
            'promotion_plan_duration' => [
                'key'            =>    'promotion_plan_duration',
                'data_type'        => 4, // json
                'default'       => [
                    'sponser' => [
                        'half_year' => [
            ...
            'feature_plans' => [
                ...
                'default'       => [
                    'pt' => [
                            ...
                            'unlimited_messaging' => [
                                'title'         => __tr('Unlimited messaging'),
                                'enable'         => true,
                                'select_user'     => 1,
                            ...
                            'business_in_one_spot' => [
                                'title'     => __tr('Business in one spot'),
                                'enable'     => true,
                                'select_user'     => 1,
                            ...
                            'see_who_views_your_page' => [
                                'title'       => __tr('See who views your page'),
                                'enable'       => true,
                                'select_user'     => 1,
                            ...
                            'access_to_customers_worldwide' => [
                                'title'       => __tr('Access to customers worldwide'),
                                'enable'       => true,
                                'select_user'     => 1,
                            ...
                            'priority_features_in_search_results' => [
                                'title'       => __tr('Priority features in search results'),
                                'enable'       => true,
                                'select_user'     => 2,
                            ...
                            'unlimited_follows_everyday' => [
                                'title'       => __tr('Unlimited follows everyday'),
                                'enable'       => true,
                                'select_user'     => 2,
                                'icon' => '<i class="fas fa-surprise fa-3x"></i>',
                            ...
                            'featured_profile_in_discovery' => [
                                'title'       => __tr('Featured Profile in discovery results.'),
                                'enable'       => true,
                                'select_user'     => 2,
                                'icon' => '<i class="fas fa-headset fa-3x"></i>',
                                'options' => [
                    ...
                    'partner' => [
                            ...
                            'unlimited_follows_everyday' => [
                                ...
                                'options' => [
                                    ...
                                    [
                                        'title'       => __tr('Pro Users'),
                                        'value'       => 2
                                    ],
                                ]
                            ],
                            'browse_incognito_mode' => [
                                'title'     => __tr('Incognito private browsing of profiles'),
                                'enable'     => true,
                                'select_user'     => 2,
                                'icon' => '<i class="fas fa-user-secret fa-3x"></i>',
                                'options' => [
