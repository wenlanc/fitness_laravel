...
class ManageUserRepository extends BaseRepository
{
    ...
    public function fetchUserSubscriptions()
    {
        ...
        $collection =     UserSubscriptionStripe::leftJoin('users', 'user_subscriptions_stripe.users__id', '=', 'users._id')
    ...
    public function getUsersSubscription($userID, $subscriptionUid)
    {
        return UsersSubscriptionStripe::where([
            'users__id' => $userID,
            '_uid'         => $subscriptionUid
        ])->first();
    }
     ...
     * @return bool
     *---------------------------------------------------------------- */
    public function deleteUserSubscription($subscription)
    {
        // Check if information deleted
