...
class ManageUserController extends BaseController
{
    ...
    public function userSubscriptionsView()
    {
        return $this->loadManageView('user.subscriptions.list');
    }

    public function userSubscriptionsList()
    {
        return $this->manageUserEngine->userSubscriptionsDataTableList();
    }

    public function processUserSubscriptionDelete($userUid, $subscriptionUid)
    {
        $processReaction = $this->manageUserEngine->processUserSubscriptionDelete($userUid, $subscriptionUid);
