...
class MessengerController extends BaseController
{
     ...
     * @return  void
     *-----------------------------------------------------------------------*/
    public function show( CommonUnsecuredPostRequest $request )
    {
        ...
        if ($request->ajax()) {
            ...
            return $this->loadPublicView('messenger.chat-box', $processReaction['data']);
        }
    }
    ...
    public function sendInquireMessage(CommonUnsecuredPostRequest $request)
    {
        $processReaction = $this->messengerEngine->processSendInquireMessage($request->all());

        return $this->processResponse($processReaction, [], [], true);
    }

    public function sendInviteMessage(CommonUnsecuredPostRequest $request)
    {
        $processReaction = $this->messengerEngine->processSendInviteMessage($request->all());
    ...
    /**
     * Get New Chat Candidate
     *
     * @return  void
     *-----------------------------------------------------------------------*/
    public function getMessengerCandidates()
    {
        return $this->messengerEngine->prepareMessengerCandidates();
    }
}
