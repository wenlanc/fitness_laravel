    ...
    public function userSignUpProcess($inputData)
    {
        $transactionResponse = $this->userRepository->processTransaction(function () use ($inputData) {
            ...
            if ($this->userRepository->storeUserAuthority($userAuthorityData)) {
                ...
                $user_time = [];
                $user_time['mon_s'] = $inputData['mon_start'];
                $user_time['mon_e'] = $inputData['mon_end'];
                $user_time['tue_s'] = $inputData['tue_start'];
                $user_time['tue_e'] = $inputData['tue_end'];
                $user_time['wed_s'] = $inputData['wed_start'];
                $user_time['wed_e'] = $inputData['wed_end'];
                $user_time['thu_s'] = $inputData['thu_start'];
                $user_time['thu_e'] = $inputData['thu_end'];
                $user_time['fri_s'] = $inputData['fri_start'];
                $user_time['fri_e'] = $inputData['fri_end'];
                $user_time['sat_s'] = $inputData['sat_start'];
                $user_time['sat_e'] = $inputData['sat_end'];
                $user_time['sun_s'] = $inputData['sun_start'];
                $user_time['sun_e'] = $inputData['sun_end'];
                $user_time['user_id'] = $newUser->_id;
                $this->userRepository->storeUserTime($user_time);
                //store profile
